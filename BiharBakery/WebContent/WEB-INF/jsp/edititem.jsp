...
<br><br><br><br>
<body>
<h1 id="bold">Itemsss Details</h1>
<form action="./modify.htm" method="GET" commandName="item">
...
<c:forEach  var="item" items="${requestScope.itemlist}">
 ...
 <td style="text-align:center;"> <input type="radio" name="itemid1" value="${item.itemId}"> </td>    
	...
	<td style="text-align:center;">${item.itemCost}</td>
        ...
        <br>
     <pre> <input type="submit" name="modify" value="MODIFY" ><input type="submit" name="delete" value="DELETE" >
     </pre>
    </form> 
   </body>
   </html>€‹
