<%-- 
    ...
    Created on : Oct 5, 2015, 2:45:51 PM
    Author     : Techm
--%>
...
padding:8px;
    ...
    <div id="fixedheader">
        <a href="adminHomePage.jsp"  style="text-decoration:none" >HOME</a>
<p align="right" >
...
<a href=""  style="text-decoration:none" ><h3 style="color:orange  align=right">LOGOUT</h3></a>
</div>
    <body>
        <pre>
